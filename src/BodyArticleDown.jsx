...
const BodyArticleDown = () => {
  return (
    ...
    <div className='BodyArticleDown'>
      ...
      <BodyArticles className="BodyArticles" src="images/AirFry.png" text="Do you need one? Probably not. Should you get one? Almost certainly, no Absolutely." title="These Are the Best Air Fryers, Because We Are All Air Fry " path="/"/>
